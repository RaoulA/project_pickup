...
<head>
  ...
  <title>Social Media | k kiosk</title>
  ...
  <meta name="X-Imperia-Live-Info" content="59a420c2-7858-4c50-92aa-faf38bcc208b/2/9/96" />

</head>

        <body id="top" class=" de socialmedia ">
...
<div class="nav-menu first open">
			<ul>
				...
				<li class="active current socialmediawand">
            ...
            <div class="sharing-container">
                <div class="sharing-links">
					<a class="whatsapp" href="whatsapp://send?text=Social Media | k kiosk" data-action="share/whatsapp/share"><i class="icon-whatsapp"></i></a>
            ...
            <div class="languages-container">
                <ul>
                    <li><a href="/de/socialmedia/index.php" class="active german">DE</a></li>                                                                            </ul>
            </div>
    ...
    <div id="contentSlot0" class="onerow slotFullWidth socialmedia  noMargin" data-accordionID="">
...
<div class="isotopelist">
    <div id="socialWall" class="isotopegrid">
