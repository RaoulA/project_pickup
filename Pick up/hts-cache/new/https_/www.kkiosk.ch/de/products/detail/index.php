...
<html class="no-js" lang="">
    <head>
        ...
        <body class="products detailpage" id="top">
        ...
        <!--[if lt IE 9]>
            ...
            <div class="infobox">
                ...
                <a class="logo" href="http://www.kkiosk.ch"><img src="inc/img/logo.png" alt="k kiosk"></a>
            </div>
            <style>
                header, nav, .wrapper, footer, .stickyfooter, .main-navigation { display: none !important; }
            </style>
        <![endif]-->
...
<div class="nav-menu first open">
            ...
            <div class="languages-container">
                <ul>
                    <li><a href="/de/products/detail/index.php" class="active german">DE</a></li>                                                                            </ul>
            </div>
