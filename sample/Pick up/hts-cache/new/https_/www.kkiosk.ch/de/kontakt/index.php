...
<head>
  ...
  <title>Kontakt | k kiosk</title>
        ...
        <meta name="keywords" content="kkiosk, kiosk, kontakt, sortiment, agenturpartner">
        <meta name="description" content="k kiosk Gönn dir was!">

  <meta name="X-Imperia-Live-Info" content="59a420c2-7858-4c50-92aa-faf38bcc208b/2/13/88" />

</head>

        <body id="top" class=" de kontakt ">
...
<div class="nav-menu first open">
			<ul>
				...
				<li class="active current kontakt">
            ...
            <div class="sharing-container">
                <div class="sharing-links">
					<a class="whatsapp" href="whatsapp://send?text=Kontakt | k kiosk" data-action="share/whatsapp/share"><i class="icon-whatsapp"></i></a>
            ...
            <div class="languages-container">
                <ul>
                    <li><a href="/de/kontakt/index.php" class="active german">DE</a></li>                                                                            </ul>
            </div>
	...
	<div class="contentText lead standardSpacing">
		<div class="text">
			<p>Anregungen, Fragen, Reklamationen nehmen wir gerne entgegen.</p>
    ...
    <div id="contentSlot2" class="onerow slotFourColumns noStyle noWidths  noMargin" data-accordionID="">
...
<div class="contentContact noStyle standardSpacing">
        <h3 class="sectionTitle">Kundenservice</h3>
...
<div class="contentContact noStyle standardSpacing">
        <h3 class="sectionTitle">Medienanfragen</h3>
...
CH-4132 Muttenz</p>
            ...
            <div class="contactEntry phone"><i class="icon-phone"></i>+41 61 467 24 53</div>



            <div class="contactEntry print"><i class="icon-print"></i>+41 58 789 38 13</div>



                <div class="contactEntry mail-alt"><i class="icon-mail-alt"></i><a href="javascript:linkUnCryptMailto('nbjmup;nfejbAwbmpsb/dpn', '1')">E-Mail</a></div>



                <div class="contactEntry link"><i class="icon-link"></i><a href="http://www.valora.com" target="_blank">valora.com</a></div>
...
<div class="contentContact noStyle standardSpacing">
        <h3 class="sectionTitle">Human Resources</h3>

    <div class="text"><p><strong>Valora Schweiz AG</strong><br />
Human Resources Retail</p>
</div>
            ...
            <div class="contactEntry phone"><i class="icon-phone"></i>+41 61 467 20 20</div>
                ...
                <div class="contactEntry link"><i class="icon-link"></i><a href="http://www.valora.com/de/career/vacancies/" target="_blank">jobs at valora.com</a></div>
	...
	<div class="contentText noStyle standardSpacing">
		<div class="text">
			<p><a class="button" href="https://recruitingapp-2538.umantis.com/Jobs/1?CompanyID=&amp;Reset=G" target="_blank">Stellenmarkt</a></p>
