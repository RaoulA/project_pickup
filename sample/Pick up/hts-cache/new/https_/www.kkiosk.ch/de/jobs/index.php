...
<head>
  ...
  <meta name="X-Imperia-Live-Info" content="59a420c2-7858-4c50-92aa-faf38bcc208b/2/10/97" />

</head>

        <body id="top" class=" de jobs ">
...
<div class="nav-menu first open">
            ...
            <div class="sharing-container">
                <div class="sharing-links">
					<a class="whatsapp" href="whatsapp://send?text=Jobs | k kiosk" data-action="share/whatsapp/share"><i class="icon-whatsapp"></i></a>
            ...
            <div class="languages-container">
                <ul>
                    <li><a href="/de/jobs/index.php" class="active german">DE</a></li>                                                                            </ul>
            </div>
    ...
    <div id="contentSlot1" class="onerow slotFullWidth fullscreen  afterFullscreen" data-accordionID="">
	...
	<div class="contentTextWithImage noStyle standardSpacing">
        <div class="background-image">
            <div class="blur-image" style="background-image:url(/media/jobs/jobs.jpg);"></div>
        </div>
		<div class="image">
			<img src="/media/jobs/jobs.jpg" alt="Jobs" />
		</div>
        <div class="text">
                <h3 class="sectionTitle"> Arbeiten für k kiosk</h3>
			<p>Werde Mitarbeitende eines vielf&auml;ltigen, dynamischen und spannenden Unternehmens mit starken regional-nationaler Verankerung und internationaler Ausrichtung.</p>
...
<div id="maincontent" class="contentAnchor"></div>
	...
	<div class="contentText quotelarge standardSpacing">
		<div class="text">
			<p>k kiosk geh&ouml;rt zur <a href="http://www.valora.com" target="_blank">Valora</a><em>. </em>Valora ist ein wirtschaftlich starkes, europaweit agierendes und unabh&auml;ngiges Handelsunternehmen. Zu Valora geh&ouml;ren k kiosk, avec., Naville, Press &amp; Books, CIGO, Brezelk&ouml;nig, Ditsch, Spettacolo und ok.&ndash; in den M&auml;rkten Schweiz, Deutschland, Luxemburg und &Ouml;sterreich.</p>
    ...
    <div id="contentSlot6" class="onerow slotTwoColumns noStyle noWidths  noMargin" data-accordionID="maintcontent">
	...
	<div class="contentText noStyle standardSpacing">
		<h3 class="sectionTitle">Berufsnachwuchs</h3>
		<div class="text">
			<p><strong>Valora und k kiosk bekennen sich zur F&ouml;rderung des Berufsnachwuchses.</strong></p>

<p>Informiere dich auf unserer Konzernwebseite von Valora &uuml;ber unser Angebot f&uuml;r Schul- und Studienabg&auml;nger. Wir bieten engagierten Schulabg&auml;ngerinnen und Schulabg&auml;ngern unterschiedlicher Schulstufen diverse Ausbildungsm&ouml;glichkeiten an verschiedenen Standorten in der Schweiz und damit einen erfolgreichen Start ins Berufsleben.</p>

<p><a class="button" href="http://www.valora.com//grundbildung/" target="_blank">Grundbildung</a>&nbsp;&nbsp; <a class="button blue" href="http://www.valora.com/de/career/apprenticeship/" target="_blank">Traineeprogramm</a></p>
	...
	<div class="contentText noStyle standardSpacing">
		<h3 class="sectionTitle">Unternehmertum</h3>
		<div class="text">
			<p><strong>Hast du dir schon &uuml;berlegt, dich selbst&auml;ndig zu machen?</strong></p>

<p>Mit unserem k kiosk Agentur-System kannst du Unternehmer/in werden<strong>.</strong></p>

<p><a class="button" href="/de/agenturpartner/"><strong>Agenturpartner/in werden</strong></a></p>
	...
	<div class="contentText noStyle standardSpacing">
		<h3 class="sectionTitle">Stellenmarkt</h3>
		<div class="text">
			<p>Sollten Sie an einem Job bei uns interessiert sein, dann starten Sie unseren Stellenmarkt.</p>

<p><a class="button" href="https://recruitingapp-2538.umantis.com/Jobs/1?CompanyID=&amp;Reset=G" target="_blank">Stellenmarkt &ouml;ffnen</a></p>
	...
	<div class="contentTitle standardSpacing">
		<h3>Mitarbeiterporträt</h3>
	</div>

	<div class="contentImage noStyle standardSpacing">
		<div class="image">
			<a href="/media/jobs/mitarbeiterportraet_biel_zbinden.pdf" target="_blank">
                <img src="/media/jobs/mitarbeiterportraet.jpg" alt="Beatrice Zbinden" />
			</a>
		</div>
	</div>
	...
	<div class="contentText noStyle standardSpacing">
		<div class="text">
			<p>Bieler Kioskfrau Beatrice Zbinden hat ein offenes Ohr f&uuml;r all ihre Kunden.</p>
